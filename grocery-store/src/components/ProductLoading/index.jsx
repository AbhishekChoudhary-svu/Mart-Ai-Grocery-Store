...
const ProductLoading = () => {
  ...
  <div
    key={idx}
    role="status"
    className="min-w-[230px] my-4 rounded-sm shadow-sm animate-pulse dark:border-gray-400"
  >
    <div className="flex items-center justify-center h-60 mb-4 bg-gray-300 rounded-sm dark:bg-gray-400">
      <svg
