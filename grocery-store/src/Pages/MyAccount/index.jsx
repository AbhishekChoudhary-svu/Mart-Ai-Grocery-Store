      ...
      <div className="container">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-3 ">
            ...
            <div className="flex flex-col  lg:mt-0 w-full">
              {/* Main Content */}
              <div className="flex-1 bg-white shadow mb-4 rounded-lg overflow-hidden">
                <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="lg:text-lg text-dm font-medium text-gray-900">
                    ...
                    {!isEditing ? (
                      ...
                      >
                        ...
                        {context.windowWidth<768 ? "Edit" : "Edit Profile"}
                      </button>
                    ) : (
