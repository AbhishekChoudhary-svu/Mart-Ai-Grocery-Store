...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      !/[A-Za-z]/.test(formFields.password) ||
  ...
  return (
    <main className=" py-10 min-h-screen  bg-[#f1f1f1d3] flex items-center justify-center md:justify-center container">
      <div className="w-full max-w-md mx-auto p-10 pt-8 pb-4 bg-white rounded-lg shadow-lg border border-gray-200">
...
function InputField({ label, id, type, value,name,onChange, placeholder }) {
  return (
